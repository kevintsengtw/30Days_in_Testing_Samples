...
public class BogusSpecimenBuilder : ISpecimenBuilder
{
    ...
    {
        // 註冊使用者相關的 Faker
        this._fakers[typeof(User)] = new Faker<User>().RuleFor(u => u.Id, f => f.Random.Guid())
        ...
        // 註冊地址相關的 Faker
        this._fakers[typeof(Address)] = new Faker<Address>().RuleFor(a => a.Id, f => f.Random.Guid())
        ...
        // 註冊公司相關的 Faker
        this._fakers[typeof(Company)] = new Faker<Company>().RuleFor(c => c.Id, f => f.Random.Guid())
        ...
        // 註冊產品相關的 Faker
        this._fakers[typeof(Product)] = new Faker<Product>().RuleFor(p => p.Id, f => f.Random.Guid())
        ...
        // 註冊訂單項目相關的 Faker
        this._fakers[typeof(OrderItem)] = new Faker<OrderItem>().RuleFor(oi => oi.Id, f => f.Random.Guid())
                                                                .RuleFor(oi => oi.Quantity, f => f.Random.Int(1, 10))
                                                                .RuleFor(oi => oi.UnitPrice, f => f.Random.Decimal(1, 500))
                                                                .Ignore(oi => oi.Product);

        // 註冊訂單相關的 Faker
        this._fakers[typeof(Order)] = new Faker<Order>().RuleFor(o => o.Id, f => f.Random.Guid())
